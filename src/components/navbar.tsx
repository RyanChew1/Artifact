...
return (
    <div className='bg-secondary-500 dark:bg-dark-4 w-full fixed top-0 left-0 font-[rokkitt] text-2xl font-bold'>
       <div className='md:flex items-center justify-between py-4 md:px-10 px-7'>
        ...
        {/* linked items */}
        <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all ease-in ${open ? 'top-12' : 'top-[-490px]'}`}>
            {
                Links.map((link) => (
            ...
            <Link to="/sign-up"> 
            <button className='btn bg-primary-400 hover:bg-primary-500 text-white md:ml-8 font-semibold px-3 py-2 rounded-xl md:static'>Sign Up</button>
            </Link>
        </ul>
       </div>
