...
const Sell = () => {
  ...
  const onSubmit = async (
    ...
    const newProduct = addProduct(user.id, productInfo.title,productInfo.description, productInfo.price)
  ...
  return (
    ...
    <div className="flex flex-row justify-center ">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      <h1 className="font-semibold text-base">Product Title</h1>
                    </FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
      ...
      {/* Your Products */}
      <div>
        <h1 className="text-3xl font-bold mt-5 ml-10">
          Your Products 
        </h1>
      </div>
    </div>
